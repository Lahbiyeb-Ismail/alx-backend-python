...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org: str, expected: Dict, func: MagicMock) -> None:
        """This method should test that
        GithubOrgClient.org returns the correct value
        """
        func.return_value = MagicMock(return_value=expected)
        goclient = GithubOrgClient(org)
        self.assertEqual(goclient.org(), expected)
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_with_license(self) -> None:
        """to test the public_repos with the argument
        license="apache-2.0" and make sure the result
